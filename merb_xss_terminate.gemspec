Gem::Specification.new do |s|
  ...
  s.authors = ["Ben Chiu"]
  s.date = %q{2008-06-03}
  s.description = %q{Plugin that auto-sanitizes data before it is saved in your ActiveRecord models}
  ...
  s.has_rdoc = true
  s.homepage = %q{http://github.com/bchiu/merb_xss_terminate}
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.1.1}
  s.summary = %q{Plugin that auto-sanitizes data before it is saved in your ActiveRecord models}
